    ...
    public Faculty getFacultyByUsername(String username) {
        ...
        try (Connection conn = DBConnection.getConnection();
            ...
            if (rs.next()) {
                ...
                faculty.setEmail(rs.getString("email"));
                faculty.setDepartment(rs.getString("department"));
                faculty.setDesignation(rs.getString("position"));
                
                System.out.println("=== getFacultyByUsername FOUND: " + faculty.getUsername() + 
                                  " (ID: " + faculty.getId() + ") ===");
                return faculty;
            } else {
                System.out.println("=== getFacultyByUsername NOT FOUND: " + username + " ===");
            }
            
        } catch (SQLException e) {
            System.err.println("=== ERROR in getFacultyByUsername: " + e.getMessage() + " ===");
            e.printStackTrace();
        }
